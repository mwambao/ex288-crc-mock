...
An 8-question, three-hour remediation mock aligned to the current public EX288 objectives. Start with `docs/PREREQUISITES.md`, then `docs/MOCK-EXAM.md`. Do not open `docs/SOLUTIONS.md` during a timed attempt.
